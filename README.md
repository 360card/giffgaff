...
GiffGaff 的付费方案分为合约（18 month contracts）、按月续费（Monthly rolling plans）、按需付费/单月有效（Pay as you go plans, One month plan）三种，所有的套餐都包含英国本地无限通话和短信，不同资费的套餐包含不同的数据流量，套餐内的数据流量都可以在欧洲范围内漫游使用，不需要额外付费。

不使用付费方案的话可以直接充值10 英镑使用按需付费/长期有效（Pay as you go plans）。
...
Giffgaff 实体卡可以从官网直接申请，但是没有£5 的话费赠送，通过360CARD [专享邀请链接](http://www.giffgaff.com/orders/affiliate/mailw51_1700277305847)申请可以获取£5 的话费赠送。

### 准备

确保有接收国际平信的条件，比如家里或单位拥有邮政的邮箱，单位的前台，或者是学校的信件收发室等。

众所周知，giffgaff 是通过平信寄出，国际平信在大陆邮政体系下送达率并不高，甚至有粉丝反馈，自己申请了五六次，都没有寄到。 下边就以我500+ 申请的经验一步一步地带大家申请，已经可以达到90% 以上的送达率。

### 填写卡片申请

访问 [专享邀请链接](http://www.giffgaff.com/orders/affiliate/mailw51_1700277305847)，根据页面提示填写邮寄信息。
...
#### 1 First name 和Last name

First name 这里填写拼音的名， Last name 填写拼音的姓，建议全部大写，提高辨识度。

#### 2 Email

请准确填写，这样我们就能收到物流寄出的反馈，粉丝实测过国内常用的邮箱也是能正确接收到邮件反馈的，极少数邮箱会收到垃圾邮件中（像139.com）。

#### 3 Country

如果是邮寄到中国大陆这里选择China，如果是邮寄到港、澳、台等其它地区根据实际情况准确填写。

#### 4 Address line 1

如果是邮寄到中国大陆，大部分情形直接使用汉语拼音从区/县一级按字英文空格分割（参考上图），包括空格在内少于50 个字符长度，为保证简洁不需要填写街道，直接写学校名称、大厦名称，楼号、单元号和房间号统一用<数字楼号>-<数字单元号>-<数字房间号> 表述，如果仍然写不完，可以补充到Address line 2 ( optional) 部分。拼音可以通过[在线汉字转拼音](https://www.qqxiuzi.cn/zh/pinyin/) 转换。

> 部分大学对国际信件的地址格式有要求，须为标准英文格式，请以学校的要求为准。

#### 5 Address line 2 (optional)

如果是邮寄到大陆，务必在地址末尾加空格并附上你的手机联系方式，其它地区也可以附上以增加送达率。

#### 6 Town/City

如果是邮寄到大陆，填写你所在的城市的拼音，如果是邮寄到港、澳、台等其它地区根据实际情况准确填写。

#### 7 State/Province

如果是邮寄到大陆，填写你所在省或省级城市的拼音大写，如果是邮寄到港、澳、台等其它地区根据实际情况准确填写省或州信息。

#### 8 Postcode

一定要准确填写，这决定了你的邮件到达中国后能否到达的关键。比如在中国大陆，不太了解自己区域邮编的可以参考[大陆邮政系统邮编查询](https://www.spb.gov.cn/search5_gy/html/searchResult.html?column=%E5%85%A8%E9%83%A8&searchWord=%E9%82%AE%E6%94%BF%E7%BC%96%E7%A0%81&columnId=0&siteCode=bm71000001)。

### 温馨提示

据称国际平信在国内的丢失率达30%多。所以把上面的填写的信息保存下来，后面重复提交时还会用到。

### 提交申请

点击order your free SIM 按钮，提交申请。回到[专享邀请链接](http://www.giffgaff.com/orders/affiliate/mailw51_1700277305847)，至少申请3-5 张。
...
邮件标题：We've posted a SIM for you

发信人：一般是no\_reply@info4.giffgaff.com

![英国实体SIM 卡giffgaff 申请、激活和使用教程](https://360card.site/wp-content/uploads/2024/12/Screenshot-2024-12-03-200154-300x147.png "英国实体SIM 卡giffgaff 申请、激活和使用教程")
...
我在大陆，这边大约是20个工作日（一个月）收到的，大部分情形我邮寄10次，大约有9次可以收到。

### 提前联系快递员

提前联系给你投递的邮政快递员，和他打好招呼，让他帮助留意快件，比如到件时可以电话联系告知你。
...
> 请务必把电话号码和用户名记录好（Giffgaff 的激活邮件中也有，也可以把对应的邮件星标）。
> 11 位的电话号码（前边为 0）只在登陆时用到，日常拨打电话、发送短信或注册 App 前边去掉 0 并加上 +44，格式为 +44 7787654321
...
拨号界面输入1626 并拨打关闭语音信箱；

拨号界面输入1616 并拨打重新开启语音信箱
...
[官网充值页](https://www.giffgaff.com/top-up)或giffgaff App 登录后，找到Add credit，按提示输入支持美元的实体信用卡（例如VISA）信息进行充值。

### 保号

giffgaff 官方的政策是每半年有余额变动或者充值。 giffgaff 官方会在保号周期到期前一周发送提醒邮件，还请特别留意。
...
查询话费余额：https://www.giffgaff.com/dashboard

续费充值（支持 PayPal）：[https://www.giffgaff.com/top-up](https://www.giffgaff.com/top-up)
...
遗失补卡：https://www.giffgaff.com/support/lost/sim
